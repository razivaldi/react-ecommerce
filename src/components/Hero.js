...
const Hero = () => {
  return (
    <>
      <div className="flex w-full h-4/5 bg-gradient-to-r from-sky-400 to-sky-200 pb-20">
        <div className="p-16 pb-0 mt-14">
          <h1>Your New Fashion Start Here!</h1>
          <p>a bit description about whats going on</p>
          <Link to='products'>
          <button className="w-1/2 bg-orange-500 rounded-lg md:w-2/6 text-xl font-semibold text-sky-100 py-3 mt-5">
            Shop Now
          </button>
          </Link>
        </div>
        <div className="w-1/2 invisible md:visible">
          <div className="w-[80%] h-[80%] bg-orange-500 relative border-white mx-auto mt-14 rounded-lg">
            <img
              src={denim}
